...
const formSchema = z.object({
    ...
    name: z.string().min(3).max(20, "name is required"),
    addressLine1: z.string().min(3).max(30, "AddressLine1 is required"),
    city: z.string().min(3).max(20, "City is required"),
    country: z.string().min(3).max(20, "Country is required"),
})
    ...
    return (
        <Form {...form}>
             <form onSubmit={form.handleSubmit(onSave)}
                className="spce-y-4 bg-gray-50 rounded-lg md:p-10"
             >
                <div>
                    <h2 className="text-2xl font-bold">User Profile</h2>
                    <FormDescription>
                        Fill in your profile data here
                    </FormDescription>
                </div>
                <br className="my-2">
                </br>
